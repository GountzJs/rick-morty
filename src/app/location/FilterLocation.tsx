...
export function FilterLocation({ action, filters, setFilters, loading }: IFilterLocation) {
  ...
  return (
    <form className="flex flex-wrap pl-8 mb-4 w-full">
      ...
      <InputText type="text" name="type" value={filters.type} placeholder="Type" onChange={handleForm} />
      <InputText type="text" name="dimension" value={filters.dimension} placeholder="Dimension" onChange={handleForm} />
      <button 
        type="button"
        disabled={loading}
